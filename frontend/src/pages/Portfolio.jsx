...
import { getPortfolio, getTrades, getStockQuote, buyStock, sellStock, searchStocks } from '../services/api';
      ...
      <main className="main-content fade-in">
        ...
        <div className="portfolio-header card">
          <div>
            ...
            <div className="metric-value">₹{totalInvested.toLocaleString('en-IN', { maximumFractionDigits: 2 })}</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="metric-value">₹{Number(user?.virtualBalance || 0).toLocaleString('en-IN', { maximumFractionDigits: 2 })}</div>
          </div>
        </div>
                ...
                <tbody>
                  {trades.map((t) => (
                    <tr key={t._id}>
                      ...
                      <td>₹{t.total.toLocaleString('en-IN', { maximumFractionDigits: 2 })}</td>
        ...
        <div className="modal-overlay" onClick={() => setTradeModal(null)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-total">
              Total: <strong>₹{total.toLocaleString('en-IN', { maximumFractionDigits: 2 })}</strong>
            </div>
